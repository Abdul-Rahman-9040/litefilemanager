...
<div class="sidebar">
    ...
    <a href="useviewinternals.html" style="font-size:13px"><i class='fa fa-edit' style='font-size:24px'></i>&emsp;View Internal Question papers</a>    
   ...
   <div class="content">
    <div class="container">
        <h1 style="text-align:center">Internal Question Papers</h1>
...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM uploaded_internals WHERE subject LIKE '%$search%' OR scheme LIKE '%$search%' OR semester LIKE '%$search%'";
