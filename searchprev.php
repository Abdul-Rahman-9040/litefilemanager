...
<div class="sidebar">
        ...
        <a href="display.php" style="font-size:13px"><i class='fa fa-trash' style='font-size:24px'></i>&emsp;Delete Documents</a>  
   ...
   <div class="content">
    <div class="container">
        <h1 style="text-align:center">Previous Papers</h1>
...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM uploaded_prev WHERE subject LIKE '%$search%' OR scheme LIKE '%$search%' OR semester LIKE '%$search%'";
